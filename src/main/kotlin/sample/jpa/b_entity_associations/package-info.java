 ...
 * 양방향은 두 Object가 A TO B, B TO A 두 방향으로 조회한다. 참조가 2개다. (단방향 X2)
 * <p>
 ...
 * 2. 비소유자(Non-Owning)는 mappedBy 속성을 사용한다. 읽기만 하겠다는 선언이다.
 * <p>
 ...
 * 2. mappedBy(Non-Owning)에서만 값을 설정하는 경우 JPA는 저장시 FK를 저장하지 않는다.(읽기 전용이기 때문에)
 */
